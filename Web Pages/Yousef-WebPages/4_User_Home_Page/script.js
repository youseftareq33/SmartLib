// JavaScript for handling image switching and button visibility
const images = [
    'image/0_advertisement_photo.png',
    'image/1_advertisement_photo.png',
    'image/2_advertisement_photo.png'
];
